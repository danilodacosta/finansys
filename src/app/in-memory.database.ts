...
export class InMemoryDatabase implements InMemoryDbService {
  ...
  createDb() {
    ...
    const categories: Category[] = [
      ...
      {id: 5 , name: 'Freelas', description: 'Trabalhos como freenlances'}
    ];

    // tslint:disable-next-line:max-line-length
    const entries: Entry[] = [
      {id: 1  , name: 'Gás de Cozinha', categoryId: categories[0].id , category: categories[0], paid: true , date: '14/10/2018' , amount: '70,00', type: 'expense', description: 'Compra semestral do gás de cozinha'} as Entry,
      ...
      {id: 6  , name: 'Video Game do Filho', categoryId: categories[2].id, category: categories[2], paid: false, date: '17/10/2018' , amount: '15,00', type: 'expense'} as Entry,
      {id: 11 , name: 'Uber',   categoryId: categories[1].id, category: categories[1], paid: true, date: '25/10/2018' , amount: '30,00', type: 'expense'} as Entry,
      {id: 12 , name: 'Aluguel',   categoryId: categories[2].id, category: categories[2], paid: false, date: '23/10/2018' , amount: '30,00', type: 'expense'} as Entry,
      ...
      {id: 14 , name: 'Pagamento Pelo Projeto XYZ', categoryId: categories[4].id, category: categories[4], paid: true, date: '25/10/2018' , amount: '2980,00', type: 'revenue', description: 'Pagamento recebido do projeto cancam 1.0'} as Entry,
      ...
      {id: 21 , name: 'Video Game do Filho',   categoryId: categories[1].id, category: categories[1], paid: true, date: '17/11/2018' , amount: '30,00', type: 'expense', description: 'Compra do Nintendo switch'} as Entry,
