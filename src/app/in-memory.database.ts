...
export class InMemoryDatabase implements InMemoryDbService {
  ...
  createDb() {
    ...
    const entries: Entry[] = [
      {id: 1  , name: 'Gás de Cozinha', categoryId: categories[0].id , category: categories[0], paid: true , date: '14/10/2018' , amount: '70,00', type: 'expense', description: 'Qualuer descrição para essa despesa'} as Entry,
      ...
      {id: 21 , name: 'Video Game do Filho',   categoryId: categories[1].id, category: categories[1], paid: true, date: '17/11/2018' , amount: '30,00', type: 'expense'} as Entry,
